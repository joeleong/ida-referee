                ...
                if s:
                    ...
                    # x.m, x->m
                        ...
                        if e.op == idaapi.cot_memptr:
                            typ2.remove_ptr_or_array()
                        strname2 = typ2.dstr()
                        if strname2.startswith("struct "):
                            strname2 = strname2[len("struct "):]
                        stid2 = idaapi.get_struc_id(strname2)
                        s2 = idaapi.get_struc(stid2)

                        mem = idaapi.get_member(s2, moff)
